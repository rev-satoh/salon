...
export const stopMeasurementButton = document.getElementById('stopMeasurementButton');
...
export const uberEatsSearchInputs = document.getElementById('uberEatsSearchInputs');
...
export const uberStoreNameInput = document.getElementById('uberStoreNameInput');
export const uberAddressInput = document.getElementById('uberAddressInput');
export const uberKeywordInput = document.getElementById('uberKeywordInput');
