const configs = {
  ...
  wakaba: {
    ...
    questions: [
      ...
      { id: 'staff', label: 'スタッフの対応はどうでしたか？（複数選択可）', type: 'checkbox', options: ['説明が丁寧だった', '高く売れた', '査定がスピーディーだった', '親しみやすかった', '知識が豊富だった', '安心して任せられた', '少し事務的だった', '査定の説明が少し早かった'] },
