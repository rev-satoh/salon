    ...
    "中国": {
        ...
        middleAreas: {
            "広島": {
                code: "FA",
                smallAreas: {
                    "袋町・中町・小町・富士見": { code: "X161" }, "本通・八丁堀・袋町・紙屋町": { code: "X164" }, "紙屋町・大手町": { code: "X163" }, "段原・皆実・宇品・千田": { code: "X384" }, "広島駅周辺・東区・安芸区・安芸郡": { code: "X166" }, "横川・十日市・天満・舟入": { code: "X167" }, "佐伯区・西区": { code: "X385" }, "廿日市": { code: "X450" }, "安佐南区・安佐北区": { code: "X386" }, "呉": { code: "X335" }, "東広島": { code: "X451" }
                }
            }, "福山・尾道": {
                code: "FC",
                smallAreas: {
